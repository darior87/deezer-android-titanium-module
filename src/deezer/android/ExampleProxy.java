...
// This proxy can be created by calling DeezerAndroidModule.createExample({message: "hello world"})
@Kroll.proxy(creatableInModule=DeezerAndroidModuleModule.class)
